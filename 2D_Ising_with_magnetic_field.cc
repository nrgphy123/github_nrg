/* 
Homework 6 Problem 1: Markov chain Monte Carlo method for 2D Ising model with magnetic field
*/
...
double h = 0.05; //External magnetic field
...
*/
	...
	for( int i=0; i < N; i++){
		for(int j=0; j<N; j++){
			...
			double delH = 2.0*current_spin*(total_neighbour_spin*0.5*log(1.0+sqrt(2.0))/x + 2.0*h) ;
